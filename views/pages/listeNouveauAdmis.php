...
testLogin();
$candidats = nouveauBacheliersAdmis();
liste("nb");
?>
<!DOCTYPE html>
<!--
...
<div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand navbar-white navbar-light">
        ...
        <div class="input-group-append">
            <a href="../../model/liste des nouveaux bacheliers.xls">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="listeNouveauAdmis.php" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Nouveaux bacheliers</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Liste des admis (Nouveaux bacheliers)</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <span class="breadcrumb float-sm-right">
                            <b><?php include_once '../../model/admin.php';
                                echo nombreAdmisNB() ?></b>&nbsp;&nbsp;Admis
                        </span>
                    </div>
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
