...
testLogin();
$candidats = anciensBacheliersRefus();
?>
<!DOCTYPE html>
<!--
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    <li class="nav-item menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="listeAncienRefus.php" class="nav-link active">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Anciens bachelier</p>
                                </a>
                            </li>
    ...
    <div class="content-wrapper" style="width: fit-content;">
        ...
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <h1 class="m-0 text-dark">Liste des refusés (Anciens bacheliers)</h1>
                    </div><!-- /.col -->
                    <div class="col-sm-6">
                        <span class="breadcrumb float-sm-right">
                            <b><?php include_once '../../model/admin.php';
                                echo nombreRefusAB() ?></b>&nbsp;&nbsp;Refusé<?php include_once '../../model/admin.php';
                            echo nombreRefusAB() > 1 ? "s" : ""; ?>
                        </span>
                    </div>
                </div><!-- /.row -->
            </div><!-- /.container-fluid -->
