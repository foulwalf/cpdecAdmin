...
if (isset($_SESSION['moyenneLimite'])) {
    $requete = nouveauBacheliersInscrits($_SESSION['moyenneLimite']);

    $candidats = $requete['candidats'];
    $nombre = $requete['nombre'];
} else {
    $candidats = nouveauBacheliersInscrits(null);
}
?>
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="listeNouveaux.php" class="nav-link active">
        ...
        <div class="content-wrapper" style="width: fit-content;">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0 text-dark">Nouveaux bacheliers</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <span class="breadcrumb float-sm-right">
                                <b><?php include_once '../../model/admin.php';
                                    echo nombreDInscritsNB() ?></b>&nbsp;&nbsp;Inscrit<?php include_once '../../model/admin.php'; echo nombreDInscritsNB() > 1 ? "s" : ""; ?>
                            </span>
                        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu-perso" aria-labelledby="dropdownMenu2">
                                                <li>
                                                    <a href="../../model/admission.php?id=<?= $candidat['id_candidat'] ?>&type=nb">
